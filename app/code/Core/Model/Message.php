...
class Core_Model_Message
{
    ...
    protected function _factory($code, $type, $class='', $method='')
    {
        switch (strtolower($type)) {
            case self::ERROR :
                $message = new Core_Model_Message_Error($code);
                break;
            case self::WARNING :
                $message = new Core_Model_Message_Warning($code);
                break;
            case self::SUCCESS :
                $message = new Core_Model_Message_Success($code);
                break;
            default:
                $message = new Core_Model_Message_Notice($code);
                break;
        }
