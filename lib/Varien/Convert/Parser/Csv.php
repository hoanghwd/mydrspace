...
class Varien_Convert_Parser_Csv extends Varien_Convert_Parser_Abstract
{
    public function parse()
    {
        ...
        setlocale(LC_ALL, Virtual::app()->getLocale()->getLocaleCode().'.UTF-8');
    ...
    public function parseTest()
    {
        ...
        $data = array();
        $sessionId = Virtual::registry('current_dataflow_session_id');
        $import = Virtual::getModel('dataflow/import');
